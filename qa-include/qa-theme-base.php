...
class qa_html_theme_base
{
	...
	public function head()
	{
		$this->output(
			...
			'<link rel = "icon" href = "qa-theme\SnowFlat\images\icon.svg" type = "image/svg">'
		);
	...
	public function head_title()
	{
		...
		$this->output('<title>' . "Saleidea". '</title>');
	}
	...
	public function body_script()
	{
		...
		'<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5f2b93a3bf7370eb">',
		'</script>'
